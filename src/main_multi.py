from .datasets.pong1m_multi import get_loader
import wandb
import argparse
import os
...
from .trainers.diffusion_forcing_multi import train
...
if __name__ == "__main__":
    ...
    loader, pred2frame = get_loader(batch_size=ctrain.batch_size, duration=ctrain.duration, fps=ctrain.fps) 
